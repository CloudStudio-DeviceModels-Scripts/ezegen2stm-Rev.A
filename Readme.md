...
# Parsing + Configuration Script – ezegen2stm - Rev. A

This **Parsing + Configuration** script is designed for the **ezegen2stm** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – ezegen2stm Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **ezegen2stm** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
