...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperatura, mientras que el segundo es un sensor de dióxido de carbono.
   ...
   endpoints.addEndpoint("1", "Estanque Agua 1", endpointType.volumeSensor);
   endpoints.addEndpoint("2", "Estanque Agua 2", endpointType.volumeSensor);
   endpoints.addEndpoint("3", "Estanque Agua 3", endpointType.volumeSensor);
   endpoints.addEndpoint("4", "Estanque Agua 4", endpointType.volumeSensor);
   endpoints.addEndpoint("5", "Estanque Agua 5", endpointType.volumeSensor);
